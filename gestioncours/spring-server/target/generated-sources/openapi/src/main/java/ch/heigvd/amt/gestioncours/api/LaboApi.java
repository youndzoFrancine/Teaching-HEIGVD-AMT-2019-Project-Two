...
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2020-01-09T14:47:28.901+01:00[Europe/Zurich]")

@Validated
@Api(value = "Labo", description = "the Labo API")
public interface LaboApi {
    ...
    @ApiOperation(value = "", nickname = "getLabos", notes = "get the list of all the Labo", response = Labo.class, responseContainer = "List", tags={  })
    @ApiResponses(value = { 
