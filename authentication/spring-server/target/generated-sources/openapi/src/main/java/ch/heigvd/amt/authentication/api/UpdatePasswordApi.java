...
@Validated
@Api(value = "update_password", description = "the update_password API")
public interface UpdatePasswordApi {
    ...
    @ApiOperation(value = "", nickname = "resetPassword", notes = "have access to ressources", tags={  })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<Void> resetPassword(@ApiParam(value = ""  )  @Valid @RequestBody UpdatePswrd updatePswrd) {
